...
1. Login into Jenkins App

2. Install Matrix plugin from manage jenkins -------> Plugins ---------> Available Plugins

3. Go to Manage Jenkins ------> Security -------> Authorization

4. Change it into ---------> Project Based Matrix Authorization Strategy

5. Add 2 Users (sam.rohan) and give them read permission.

6. Go to project configure & Enable project-based security

7. Add 2 Users (sam.rohan) and give them permissions according to the question.
